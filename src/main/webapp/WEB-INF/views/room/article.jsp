                    	...
                    	<br/><br/><br/><br/><br/>
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="form-group"><!-- 마이룸 테이블의 member 가져오기 : dto.manager || dto.member -->
	                                    ...
	                                    <c:if test="${sessionScope.userInfo.userId == dto.manager}">
		                                    <a href="<%=cp%>/rroom.action?roomNum=${dto.roomNum}" class="btn btn-primary btn-user btn-block">
		                                        방 참가하기
		                                    </a>
	                                    </c:if>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<%=cp%>/list.action?${params }">전체 방 목록으로 돌아가기</a>
                                    </div>
                                    <div>
                                    	<input type="button" value=" 수정 " class="btn2" onclick="javascript:location.href='<%=cp%>/updated.action?roomNum=${dto.roomNum }&${params }';"/>
                                    	<input type="button" value=" 삭제 " class="btn2" onclick="javascript:location.href='<%=cp%>/deleted.action?roomNum=${dto.roomNum }&${params }';"/>
                                    </div>
                                </div>
                            </div>
