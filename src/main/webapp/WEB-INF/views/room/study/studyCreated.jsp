...
<head>
	...
	function sendIt() {
		...
		//가상경로
		f.action = "<%=cp%>/studyCreated_ok.action";
		f.submit();
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"><b>공부 방 만들기</b></h1>
                            </div>
                            <form action="" name="myForm" class="user" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                               	...
                               	<input type="hidden" name="subject" value="공부">
                            ...
                            <div class="text-center">
                                <a class="small" href="<%=cp%>/studyList.action">공부 방 목록으로 돌아가기</a>
                            </div>
                        </div>
                    </div>
                </div>
