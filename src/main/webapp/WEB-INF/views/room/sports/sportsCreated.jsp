...
<head>
	...
	function sendIt() {
		...
		//가상경로
		f.action = "<%=cp%>/sportsCreated_ok.action";
		f.submit();
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"><b>운동 방 만들기</b></h1>
                            </div>
                            ...
                            <div class="text-center">
                                <a class="small" href="<%=cp%>/sportsList.action">운동 방 목록으로 돌아가기</a>
                            </div>
                        </div>
                    </div>
                </div>
