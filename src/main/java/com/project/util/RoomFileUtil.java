...
public class RoomFileUtil {
	...
	// 파일 수정
	public List<Map<String, Object>> parseUpdateFileInfo(RoomDTO dto, MultipartHttpServletRequest mpRequest)
			throws Exception {
		...
		while (it.hasNext()) {
			...
			if (multipartFile.isEmpty() == false) {
				 ...
				 * listsMap.put("originalFileName", keepOriginalFileName); }else {
				 * listsMap.put("storedFileName", storedFileName);
				 * listsMap.put("originalFileName", originalFileName); }
				 */
