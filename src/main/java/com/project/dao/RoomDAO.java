...
public class RoomDAO {
	...
	/*
	 * //파일 입력 public void insertFile(Map<String,Object> map) {
	 * 
	 * sessionTemplate.insert("com.roomMapper.insertFile", map);
	 * 
	 * }
	 * 
	 * //파일 출력 public List<Map<String,Object>> selectFileList(int roomNum) {
	 * 
	 * List<Map<String,Object>> lists =
	 * sessionTemplate.selectList("com.roomMapper.selectFileList",roomNum);
	 * 
	 * return lists;
	 * 
	 * }
